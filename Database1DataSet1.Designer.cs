...
namespace Software_for_Filling_Station {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string firstName, string lastName, string username, string password, string id) {
...
namespace Software_for_Filling_Station.Database1DataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([firstName] = @Original_firstName) AND ([lastNa" +
                "me] = @Original_lastName) AND ([username] = @Original_username) AND ([password] " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([firstName], [lastName], [username], [password], [id])" +
                " VALUES (@firstName, @lastName, @username, @password, @id);\r\nSELECT firstName, l" +
                "astName, username, password, id FROM Users WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [firstName] = @firstName, [lastName] = @lastName, [username] = @username, [password] = @password, [id] = @id WHERE (([firstName] = @Original_firstName) AND ([lastName] = @Original_lastName) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([id] = @Original_id));
SELECT firstName, lastName, username, password, id FROM Users WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT firstName, lastName, username, password, id FROM dbo.Users";
        ...
        public virtual int Delete(string Original_firstName, string Original_lastName, string Original_username, string Original_password, string Original_id) {
        ...
        public virtual int Insert(string firstName, string lastName, string username, string password, string id) {
            if ((firstName == null)) {
        ...
        public virtual int Update(string firstName, string lastName, string username, string password, string id, string Original_firstName, string Original_lastName, string Original_username, string Original_password, string Original_id) {
            if ((firstName == null)) {
                throw new global::System.ArgumentNullException("firstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, string username, string password, string Original_firstName, string Original_lastName, string Original_username, string Original_password, string Original_id) {
